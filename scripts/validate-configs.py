...
if len(clones) != 89:
    warn(f"expected 89 wackydb clones (24 capes + 10 pets + 8 uniques + 7 elite uniques "
         f"+ 6 hull keels + 6 riddle rewards + 6 jewellery + 4 riddle-stones "
         f"+ 3 crystal key parts + 8 oath capes + 2 curios + 5 vanity cloaks), found {len(clones)}")
