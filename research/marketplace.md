...
- `offerings` (`= true`, Seeress, 8 cumulative pages): TrophyDeer 190c, AncientSeed 190c, WitheredBone 150c,
  DragonEgg 310c, GoblinTotem 225c, Bell 1,200c; a summon = ~1.25x the mean boss purse, Bonemass 2.5x, Fader ~3x
  (the late sink). Queen: TrophySeekerBrute 440c (`offeraltar_queen`, 3), page 6 at `defeated_queen`; Bell page 7;
  Kall: HatefulBlood 1,500c (3 at `offeraltar_FrozenKing_bossroom`; mined from `BlackIce_Core`), page 8 at `defeated_frozenking_p3`.
