...
| `drop_that.drop_table.cfg` | generated by `scripts\gen-objects.py` from `loot\objects.csv`: skilling pet (table below), curio 1/500 on 23 `TreeBase` trees and 11 ore tables, gem 1/256 on ore |
...
| Table | Segments | Pet 1/300,000 | Curio 1/500 | Gem 1/256 |
|---|---|---|---|---|
| `rock4_copper_frac` | 79 | 1/3,800 | 1/6.8 | 1/3.8 |
| `mudpile_frac` | 20 | 1/15,000 | 1/25.5 | none |
| `mudpile2_frac` | 28 | 1/10,700 | 1/21.9 (1/600) | none |
| `rock3_silver_frac` | 141 | 1/2,130 | 1/4.1 | 1/2.4 |
| `silvervein_frac` | 106 | 1/2,830 | 1/5.2 | 1/2.9 |
| `goldvein_frac` | 97 | 1/3,090 | 1/5.7 | 1/3.2 |

Skilling pets = OSRS hours (~400 h: rock golem iron 1/741,600 per ore at ~1,800/hr; beaver
yew 1/145,013 per log at ~350/hr). Valheim estimates, unmeasured: 720 segments/hr, 40 trees/hr.

| Pet row | Target |
|---|---|
| mining, per segment or `MineRock` area | 1/300,000 |
| `MineRock_Tin` (per node, ~3.5 actions) | 1/85,000 |
| `MineRock_Obsidian` (per node, ~6.5 actions) | 1/45,000 |
| woodcutting, per tree felled | 1/16,000 |
