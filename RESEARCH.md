...
**Hunt contracts** (`Quests\osrsheim_quests_slayer.cfg`, 14 hunts + 5 herb contracts live,
43 staged,
...
(`defeated_dragon`); 200-700c + seeds + `Skill_EXP: Farming`. Harvest counts
any Pickable via `Pickable.RPC_Pick`, so your own plots count.
