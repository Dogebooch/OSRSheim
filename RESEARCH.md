...
| Smoothbrain Exploration | HX | Agility feel | loads; cfg untouched |
| JuJuz1 SkillGainModifier | TS | vanilla skill XP 0.5x | loads; cfg untouched, unverified on 1.0 |
| BetterUI_ForeverMaintained | TS | XP bar | loads; Hexium flags `Smelter.UpdateHoverTexts` missing on 1.0; kept |
| sighsorry Trolling Fishing | TS | Fishing bite chance and bonus drops scale with skill (§18) | installed 2026-09-21, untested |
| Marlthon OdinShip | TS | 7 hulls, keel-gated (§6, §7, §18) | installed 2026-09-21, untested |
