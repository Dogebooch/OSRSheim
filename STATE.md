...
Config audit: unfixed KG Talk quotes + buff multipliers; BetterUI tooltip warning (§11).
Not launched since 2026-09-21: spawn spacing (§12), hellbroths on Alchemy (§6), mage purses (§7),
lore renames (§7, §11), Wizardry `supplies` + cauldron off (§21), Halla's
...
clones, `.104` drops, 6 quests, 15 OdinShipPlus recipes (§6, §7, §11, §18; 137
...
1. **Throwaway world first** (~20 s in-world): regenerates the `BepInEx\Debug\`
   dumps; confirm `*Mage_TW` / `Hellbroth_of_*`; extract location YAML.
   Review MWL density now; `genloc` cannot retrofit explored terrain (§13).
...
4. Watch for in play: superiors spawning, EpicLoot Haldor / map / bounty
   ...
   maps (pure sink), supplies meads and food. Bounties (§10): board empty until the biome boss dies, one at a time, x6 coins.
   ...
   missing grey. Hulls: OdinShipPlus Hammer category, keel off a boss (12.5%)
